...
class LGSensorInputSource(LGSensor):
    ...
    def __init__(self, config_device: ConfigDevice, device: client.LGDevice):
        """Initialize the class."""
...
class LGSensorVolume(LGSensor):
    ...
    def sensor_value(self) -> str | float:
        """Return sensor value."""
        return self._device.volume if self._device.volume else 0
...
class LGSensorMuted(LGSensor):
    ...
    def sensor_value(self) -> str | float:
        """Return sensor value."""
        return "on" if self._device.muted else "off"
...
class LGSensorSoundOutput(LGSensor):
    ...
    def sensor_value(self) -> str | float:
        """Return sensor value."""
        return self._device.sound_mode if self._device.sound_mode else ""
